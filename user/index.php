            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        <h4 class="text-white text-uppercase mb-md-3">Welcome <?php echo $_SESSION['uname']; ?></h4>
                        <h1 class="display-1 text-white mb-md-4">SPEEDACAB</h1>
                        <a href="cab.php" class="btn btn-primary py-md-3 px-md-5 mt-2">BOOK NOW</a>
                    </div>
                </div>
            </div>
...
<div class="container-fluid py-5">
    <div class="container pt-5 pb-3">
        <h1 class="display-4 text-uppercase text-center mb-5">Welcome To <span class="text-primary">SPEEDAA CAB</span>
        </h1>
